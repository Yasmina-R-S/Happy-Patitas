...
class _CollarManagementScreenState
    extends State<CollarManagementScreen> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _buildSectionHeader(
            context,
            T.of(context, 'connected_devices'),
          ),

          ..._devices.map(
                (device) => _buildCollarCard(context, device),
          ),
